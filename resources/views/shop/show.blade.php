...
@section('content')
    ...
    <div class="mx-auto max-w-screen-xl p-4 mt-10 bg-[#ebcdd7] rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl">
                ...
                <div id="mainImageModal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative p-4 ">
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <!-- Main Image in Modal -->
                            <img id="mainImageModalImg" src="{{ URL::to('storage/' . $record->main_image_url) }}" class="mx-auto object-contain" alt="Main product image">
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg">
                ...
                <form action="{{ route('cart.add', $record->id) }}" method="GET" class="space-y-6">
                    ...
                    <div class="md:flex items-center md:space-x-4">
                        ...
                        <button type="submit" 
                                class="flex-1 w-full md:mt-0 mt-4 bg-[#2B3467] text-white px-8 py-3  mx-auto rounded-lg hover:bg-[#1a1f3d] transition-colors flex items-center justify-center space-x-2">
