    ...
    <form class="pt-4" action="{{ route('category.update', $record->id) }}" enctype="multipart/form-data"
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-1">
            <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2">
                <div>
                    <label for="name_en" class="block mb-2 text-sm font-medium text-gray-900 d:text-white">{{session('lang') == 'en' ? 'name en' : 'الاسم بالاجنبية'}}</label>
                ...
                <div>
                    <label for="name_ar" class="block mb-2 text-sm font-medium text-gray-900 d:text-white">{{session('lang') == 'en' ? 'name ar' : 'الاسم بالعربية'}}</label>
                ...
                <div>
                    <label for="parent_id" class="block mb-2 text-sm font-medium text-gray-900 d:text-white">{{session('lang') == 'en' ? 'Parent category' : 'التصنيف المشتق منه'}}</label>
