    ...
    <form class="pt-4" action="{{ route('productView.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-1">
            <div class="grid grid-cols-1 gap-4 border-2 p-4 md:grid-cols-2">
                ...
                <div>
                    <label for="section_id" class="block mb-2 text-sm font-medium text-gray-900 d:text-white">Select
                        Section
                        option</label>
                ...
                <div>
                    <label for="branch_id" class="block mb-2 text-sm font-medium text-gray-900 d:text-white">Select
                        Branch
                        option</label>
                ...
                <script>
                    ...
                    checkboxElement.addEventListener('change'function() {
                        ...
                        if (selectedValue) {
                            checkboxElement.value = selectedValue; // Set the checkbox value
                            checkboxElement.checked = true; // Optionally check the checkbox
                        } else {
                            checkboxElement.value = ''; // Clear the checkbox value
